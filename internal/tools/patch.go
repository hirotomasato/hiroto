...
func patchFile(ctx context.Context, args map[string]any) Result {
	...
	return Result{Output: fmt.Sprintf("patched %s (%d lines, 1 replacement)", path, lines)}
}